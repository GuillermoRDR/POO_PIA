...
void Model::prepShader(Shader& gpuDemo) {
    ...
    glm::vec3 fogColor(0.5f, 0.5f, 0.5f); // Color gris de la niebla
    gpuDemo.setVec3("fogColor", fogColor);
    gpuDemo.setFloat("fogDensity", 0.01f); // Ajusta la densidad aquí
...
bool Model::getTieneColision() { return tieneColision; }

void Model::setTieneColision(bool tieneColision) { this->tieneColision = tieneColision; }