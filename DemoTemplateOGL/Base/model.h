...
private:
    ...
    float salud;
    float ataque;
    Model* arma; // Puntero a un objeto de tipo Arma (puede ser nullptr si no tiene arma)
    bool estaVivo;
    float damage;
...
public:
    ...
    bool getTieneColision();
    void setTieneColision(bool tieneColision);
